...
<body>
    <!--Superior Container -->
    <section class="SuperiorContainer">
        ...
        <section class="ProductGridCards">
            ...
            <div class="CardProduct">
                <div class="CardImageArea">
                    ...
                    <!--Image Product-->
                    <img src="http://verbrascorp.com.br/home/wp-content/uploads/2023/03/TEXTURA_QUARTZO_25KG.png" alt="">
                </div>
                <!--Name Product-->
                <h3 class="CardNameProduct">Textura Nobre Premium 27kg</h3>
                <!--Product Price-->
            ...
            <div class="CardProduct">
                <div class="CardImageArea">
                    ...
                    <!--Image Product-->
                    <img src="http://verbrascorp.com.br/home/wp-content/uploads/2023/03/TEXTURA_EXTERNA_25KG.png" alt="">
                </div>
                <!--Name Product-->
                <h3 class="CardNameProduct">Textura Nobre Premium 27kg</h3>
                <!--Product Price-->
            ...
            <div class="CardProduct">
                <div class="CardImageArea">
                    ...
                    <!--Image Product-->
                    <img src="http://verbrascorp.com.br/home/wp-content/uploads/2023/03/TEXTURA_INTERNA_25KG.png" alt="">
                </div>
                <!--Name Product-->
                <h3 class="CardNameProduct">Textura Nobre Premium 27kg</h3>
                <!--Product Price-->
            ...
            <div class="CardProduct">
                <div class="CardImageArea">
                    ...
                    <!--Image Product-->
                    <img src="http://verbrascorp.com.br/home/wp-content/uploads/2023/01/xESMLATE_EXTRARRAPIDO1.png.pagespeed.ic_.tSZt9GLJdT.png" alt="">
                </div>
                <!--Name Product-->
                <h3 class="CardNameProduct">Textura Nobre Premium 27kg</h3>
                <!--Product Price-->
