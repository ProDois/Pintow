    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
        <div class="h-19.5">
            ...
            <div class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700 grid justify-center">
                <img src="./assets/img/logo-ct.png" class="inline h-full max-w-full max-h-8" alt="main_logo" />
                <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Painel administrativo</span>
            </div>
        </div>
